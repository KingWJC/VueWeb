<template>
  <div class="cases-table-filter-light">
    <table class="cases-table-filter-light__table">
      <thead class="cases-table-filter-light__table-header">
        <tr>
          <th>住院流水号</th>
          <th>患者</th>
          <th>性别</th>
          ...
          <!--科室-->
          <th>
            <div class="cases-table-filter-light__condition-dept">
              <div
                :class="{
                  'cases-table-filter-light__condition-select--disabled':
                    disabled,
                  'cases-table-filter-light__condition-select--active':
                    showDept
                }"
                class="cases-table-filter-light__condition-select"
          ...
          <!--医生-->
          <th>
            <div class="cases-table-filter-light__condition-doctor">
              <div
                :class="{
                  'cases-table-filter-light__condition-select--disabled':
                    disabled,
          ...
          <!-- 出院时间 -->
          <th>
            <div class="cases-table-filter-light__condition-date">
              <div
                :class="{
                  'cases-table-filter-light__condition-select--disabled':
                    disabled,
