      ...
      <el-row :gutter="20">
        ...
        <el-col :span="5">
          <div class="grid-content bg-purple">
            ...
            <el-steps
              :space="120"
              :active="progressData1.Active"
              :processStatus="progressData1.ProcessStatus"
              direction="vertical"
        ...
        <el-col :span="4">
          <div class="grid-content bg-purple">
            ...
            <el-steps
              :space="120"
              :active="progressData2.Active"
              :processStatus="progressData2.ProcessStatus"
              direction="vertical"
              finishStatus="success"
            >
              <el-step title="认证申请">></el-step>
  ...
  export default {
    ...
    methods: {
      ...
      initData(obj) {
        ...
        Axios.get(resolveApiRoute("home-info"), {
          params: {
          ...
          (res) => {
            ...
            if (res.data.Code === 0) {
              ...
              this.progressData1 = res.data.Data.ProgressData;
            } else {
