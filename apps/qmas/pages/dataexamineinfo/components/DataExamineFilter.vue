<template>
  <div class="data-examine-filter clearfix">

    <div class="data-examine-filter__counts">
      <span>认证机构:</span>
    ...
    <div class="data-examine-filter__btnbox">
      <span>认证类型:</span>
      <select-dropdown-v2
        v-model="cachedType"
    ...
    <div class="data-examine-filter__searchbox clearfix">
      <div class="data-examine-filter__searchbox-searchbar clearfix">
        <a class="data-examine-filter__basicbtn"
          href="javascript:;"
          @click="search">查询</a>
        <a
          href="javascript:;"
          class="data-examine-filter__basicbtn
          data-examine-filter__searchbox-reset"
          @click="reset"
        >重置</a>
      </div>
    </div>
