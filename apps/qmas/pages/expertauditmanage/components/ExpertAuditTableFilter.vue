<template>
  <div class="expert-audit-table-filter">
    <table class="expert-audit-table-filter__table">
      <thead class="expert-audit-table-filter__table-header">
        <tr>
          <th>认证医院</th>
          <th>认证科室</th>
          <!-- 认证类型 -->
...
<script>
  ...
  export default {
    name: "expert-audit-table-filter",
