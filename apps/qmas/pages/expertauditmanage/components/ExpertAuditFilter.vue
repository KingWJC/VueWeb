<template>
  <div class="expert-audit-filter clearfix">
    <div class="expert-audit-filter__counts">
      <span>认证机构:</span>
    ...
    <div class="expert-audit-filter__btnbox">
      <span>认证类型:</span>
      <select-dropdown-v2
        v-model="cachedType"
    ...
    <div class="expert-audit-filter__searchbox clearfix">
      <div class="expert-audit-filter__searchbox-searchbar clearfix">
        <a class="expert-audit-filter__basicbtn"
          href="javascript:;"
          @click="search">查询</a>
        <a
          href="javascript:;"
          class="expert-audit-filter__basicbtn
           expert-audit-filter__searchbox-reset"
          @click="reset"
        >重置</a>
      </div>
    </div>
