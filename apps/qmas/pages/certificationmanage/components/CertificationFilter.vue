<template>
  <div class="certification-filter clearfix">
    <div class="certification-filter__counts">
      <span>认证机构:</span>
    ...
    <div class="certification-filter__btnbox">
      <span>认证类型:</span>
      <select-dropdown-v2
        v-model="cachedType"
    ...
    <div class="certification-filter__searchbox clearfix">
      <div class="certification-filter__searchbox-searchbar clearfix">
        <a class="certification-filter__basicbtn"
          href="javascript:;"
          @click="search">查询</a>
        <a
          href="javascript:;"
          class="certification-filter__basicbtn
          certification-filter__searchbox-reset"
          @click="reset"
        >重置</a>
      </div>
    </div>
