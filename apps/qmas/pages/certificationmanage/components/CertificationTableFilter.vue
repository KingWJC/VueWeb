<template>
  <div class="certification-table-filter">
    <table class="certification-table-filter__table">
      <thead class="certification-table-filter__table-header">
        <tr>
          <th>认证医院</th>
          <th>认证科室</th>
          <th>认证类型</th>
...
<script>
  ...
  export default {
    name: "certification-table-filter",
