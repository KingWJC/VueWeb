<template>
  <div class="certification-manage">
    ...
    <div class="certification-manage__tablecontent">
      <template v-if="!isShowLoading">
        <template v-if="bodyData">
          <div class="certification-manage__tablecontent-body">
            <certification-table-body :bodyData="bodyData"
              @refreshData="refreshData"></certification-table-body>
          </div>
        ...
        <template v-else>
          <qa-no-content title="暂无认证记录"></qa-no-content>
        </template>
      </template>
    </div>
  </div>
...
<script>
  ...
  import CertificationTableBody from "./CertificationTableBody";
  import CertificationTableFilter from "./CertificationTableFilter";
  ...
  export default {
    ...
    methods: {
      ...
      fetchData() {
        ...
        Axios.post(
          resolveApiRoute("certification-manage"),
          this.getApiPara()
        ).then(
          (res) => {
            this.$hideLoading();
