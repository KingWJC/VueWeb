<template>
  <div class="scene-examine-filter clearfix">

    <div class="scene-examine-filter__counts">
      <span>认证机构:</span>
    ...
    <div class="scene-examine-filter__btnbox">
      <span>现场评审级别:</span>
      <select-dropdown-v2
        v-model="cachedType"
    ...
    <div class="scene-examine-filter__searchbox clearfix">
      <div class="scene-examine-filter__searchbox-searchbar clearfix">
        <a class="scene-examine-filter__basicbtn"
          href="javascript:;"
          @click="search">查询</a>
        <a
          href="javascript:;"
          class="scene-examine-filter__basicbtn
          scene-examine-filter__searchbox-reset"
          @click="reset"
        >重置</a>
      </div>
    </div>
