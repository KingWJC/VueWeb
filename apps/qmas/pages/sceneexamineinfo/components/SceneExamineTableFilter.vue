<template>
  <div class="scene-examine-table-filter">
    <table class="scene-examine-table-filter__table">
      <thead class="scene-examine-table-filter__table-header">
        <tr>
          <th>认证医院</th>
          <th>认证科室</th>
          <th>现场评审日期</th>
...
<script>
  ...
  export default {
    name: "scene-examine-table-filter",
