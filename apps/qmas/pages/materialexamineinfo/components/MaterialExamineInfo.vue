<template>
  <div class="material-examine-info">
    <material-examine-table-filter
      :disabled="filterDisabled"
    ></material-examine-table-filter>

    <div class="material-examine-info__tablecontent">
      <template v-if="!isShowLoading">
        <template v-if="bodyData">
          <div class="material-examine-info__tablecontent-body">
            <material-examine-table-body :bodyData="bodyData"
              @refreshData="refreshData"></material-examine-table-body>
          </div>
        ...
        <template v-else>
          <qa-no-content title="暂无材料审核数据"></qa-no-content>
        </template>
      </template>
    </div>
  </div>
...
<script>
  ...
  import MaterialExamineTableBody from "./MaterialExamineTableBody";
  import MaterialExamineTableFilter from "./MaterialExamineTableFilter";

  export default {
    name: "material-examine-info",

    components: {
      Paginator,
      MaterialExamineTableBody,
      MaterialExamineTableFilter,
      QaNoContent
    },
    ...
    methods: {
      ...
      fetchData() {
        ...
        Axios.post(
          resolveApiRoute("material-examine-list"),
          this.getApiPara()
        ).then(
          (res) => {
            this.$hideLoading();
