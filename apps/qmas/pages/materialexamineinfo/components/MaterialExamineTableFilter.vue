<template>
  <div class="material-examine-table-filter">
    <table class="material-examine-table-filter__table">
      <thead class="material-examine-table-filter__table-header">
        <tr>
          <th>认证医院</th>
          <th>认证科室</th>
          <th>认证类型</th>
...
<script>
  ...
  export default {
    name: "material-examine-table-filter",
