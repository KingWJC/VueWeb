    ...
    <table class="log-table-filter__table">
      <thead class="log-table-filter__table-header">
        <tr>
          ...
          <!--操作时间-->
          <th>
            <div class="log-table-filter__condition-date">
              <div
                :class="{
                  'log-table-filter__condition-select--disabled': disabled,
                  'log-table-filter__condition-select--active': showCalendar
                }"
                class="log-table-filter__condition-select"
                @click="changeActiveCondition('date')">
                <span :title="outDateTitle"
                  class="log-table-filter__condition-date-title">
                  {{ outDateTitle }}
                </span>
              </div>
          ...
          <!-- 操作类型 -->
          <th>
            <div class="log-table-filter__condition-type">
              <div
                :class="{
                  'log-table-filter__condition-select--disabled': disabled,
                  'log-table-filter__condition-select--active': showType
                }"
                class="log-table-filter__condition-select"
              ...
              <options-dropdown
                ...
                :optionArr="typeList"
                allName="操作类型"
                objectCode="ACTION_TYPE"
                objectName="ACTION_TYPE_NAME"
          ...
          <!--操作事件-->
          <th>
            <div class="log-table-filter__condition-event">
              <div
                :class="{
                  'log-table-filter__condition-select--disabled': disabled,
                  'log-table-filter__condition-select--active': showEvent
                }"
                class="log-table-filter__condition-select"
                @click="changeActiveCondition('eventselect')">
                <span :title="allEventTitle">{{ allEventTitle }}</span>
              </div>
              ...
              <options-dropdown
                ...
                :optionArr="eventList"
                allName="操作事件"
                objectCode="ACTION_EVENT"
                objectName="ACTION_EVENT_NAME"
                @cancelSelect="showEvent = !showEvent"
                @checkboxAll="eventCheckboxAll">
              </options-dropdown>
            </div>
          </th>
          ...
          <!-- 操作人 -->
          <th>
            <div class="log-table-filter__condition-operator">
              <div
                :class="{
                  'log-table-filter__condition-select--disabled': disabled,
                  'log-table-filter__condition-select--active': showOperator
                }"
                class="log-table-filter__condition-select"
                @click="changeActiveCondition('operator')">
                <span :title="allOperatorTitle">{{ allOperatorTitle }}</span>
              </div>

              <options-dropdown
                :display="showOperator"
                :optionArr="operatorList"
                allName="操作人"
                objectCode="USER_CODE"
                objectName="USER_NAME"
                @cancelSelect="showOperator = !showOperator"
                @checkboxAll="operatorCheckboxAll">
              </options-dropdown>
            </div>
          </th>
          <th>操作结果</th>
